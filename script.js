...
// labelDate.textContent = new Intl.DateTimeFormat(locale, options)
//   .format(now)
...
console.log(443595939580348905903490589038590389045890389045n);
console.log(BigInt(443595921));

//  Operations
console.log(1000n + 1000n);
console.log(44359593958034890590349058903n + 1000n);
// console.log(Math.sqrt(16n));


const huge = 210301203012388338338n
const num = 23
...
function myFunction(a) {
  let res = 0;
  Object.keys(a).forEach((element, i) => {
    res += a[element]
  });
  console.log(res);
  // const as = a.reduce((prev, cur) => prev + cur, 0)
  // console.log(as);
}
...
console.log(new Date('Jul 21 2022 21:03:05'));
...
/* onst future = new Date(2037, 10, 19, 15, 23)
console.log(Number(future));
const days1 = calcDaysPassed(new Date(2037, 3, 4), new Date(2037, 3, 14))
console.log(days1); */
/* 
const num = 23452525235.31
...
const pizzaTimer = setTimeout((ing1, ing2) => console.log(`Ur pizzaa with ${ing1} and ${ing2}`), 3000, ...ingredients)
